...
<head>
    ...
    <title>{{ $slug }} - {{ config('app.name', 'PAMS') }}</title>
...
<body class="font-sans antialiased bg-gray-50">
        ...
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    @else
                        <a href="{{ url('/admin/login') }}" class="text-gray-700 hover:text-blue-600 font-medium transition-colors">
                            Login
                        </a>
                        <a href="{{ url('/admin/register') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-medium transition-colors">
                            Daftar Affiliate
                        </a>
                    @endauth
                </div>
            ...
            <div id="mobile-menu" class="hidden md:hidden pb-4">
                <div class="flex flex-col space-y-3">
                    ...
                    @else
                        ...
                        <a href="{{ url('/admin/register') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-medium transition-colors text-center">
                            Daftar Affiliate
                        </a>
                    @endauth
                </div>
    ...
    <!-- Page Content -->
    <main>
        @livewire('property-detail', ['slug' => $slug])
    </main>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        ...
                        @else
                            <li><a href="{{ url('/admin/login') }}" class="hover:text-white transition-colors">Login</a></li>
                            <li><a href="{{ url('/admin/register') }}" class="hover:text-white transition-colors">Daftar Affiliate</a></li>
                        @endauth
                    </ul>
                </div>
                <div>
