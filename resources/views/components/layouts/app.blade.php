...
<head>
    ...
    <meta name="keywords"
        content="{{ $settings && $settings->seo_meta_keywords ? $settings->seo_meta_keywords : 'properti, affiliate, real estate' }}">

    <!-- Open Graph Meta Tags -->
    <meta property="og:title"
        content="{{ $settings && $settings->seo_meta_title ? $settings->seo_meta_title : config('app.name', 'PAMS') }}">
...
<body class="font-sans antialiased bg-gray-50">
    ...
    <header class="fixed top-0 left-0 w-full z-50 transition-all duration-300" id="main-header">
        <nav class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-24">
                ...
                <div class="flex items-center flex-shrink-0">
                    <a href="{{ $settings && $settings->logo_url ? $settings->logo_url : route('properties.index') }}"
                        ...
                        @else
                            ...
                            <span class="text-2xl font-bold text-white tracking-tight">MND<span
                                    class="text-blue-400">Properti</span></span>
                        @endif
                    </a>
                </div>
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="{{ route('properties.index') }}"
                        class="text-gray-300 hover:text-white font-medium transition-colors text-sm uppercase tracking-wider">Beranda</a>
                    <a href="{{ route('properties.index') }}"
                        class="text-white font-medium transition-colors text-sm uppercase tracking-wider">Katalog</a>
                    <a href="{{ route('about-us') }}"
                        class="text-gray-300 hover:text-white font-medium transition-colors text-sm uppercase tracking-wider">Tentang
                        Kami</a>
                    <a href="{{ route('contact') }}"
                        class="text-gray-300 hover:text-white font-medium transition-colors text-sm uppercase tracking-wider">Kontak</a>
                </div>
                ...
                <div class="hidden md:flex items-center space-x-6">
                    @auth
                        <a href="{{ url('/admin') }}"
                            class="text-white font-medium hover:text-blue-400 transition-colors">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}"
                            class="text-white font-medium hover:text-blue-400 transition-colors">Masuk</a>
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}"
                                class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2.5 rounded-full font-medium transition-all transform hover:scale-105 shadow-lg shadow-blue-600/30">
                                Daftar Affiliate
                            </a>
                        @endif
                    @endauth
                ...
                <div class="md:hidden">
                    <button type="button" id="mobile-menu-button"
                        ...
                        <svg id="menu-icon-close" class="w-8 h-8 hidden" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <!-- Mobile menu -->
            <div id="mobile-menu"
                class="hidden md:hidden bg-gray-900/95 backdrop-blur-xl absolute top-24 left-0 w-full border-t border-gray-800 shadow-2xl">
                <div class="flex flex-col p-6 space-y-4">
                    <a href="{{ route('properties.index') }}"
                        class="text-gray-300 hover:text-white font-medium text-lg">Beranda</a>
                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}"
                                class="bg-blue-600 text-white px-6 py-3 rounded-lg font-medium text-center shadow-lg">
                                Daftar Affiliate
                            </a>
                        @endif
                    @endauth
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                ...
                <div class="space-y-6">
                    ...
                    <p class="text-gray-400 leading-relaxed">
                        Platform properti terpercaya dengan ribuan pilihan hunian eksklusif untuk masa depan Anda.
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        <li><a href="#" class="text-gray-400 hover:text-blue-400 transition-colors">Beranda</a>
                        </li>
                        <li><a href="#" class="text-gray-400 hover:text-blue-400 transition-colors">Katalog
                                Properti</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-blue-400 transition-colors">Tentang
                                Kami</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-blue-400 transition-colors">Kontak</a>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        <li><a href="{{ route('legal.terms') }}"
                                class="text-gray-400 hover:text-blue-400 transition-colors">Syarat & Ketentuan</a></li>
                        <li><a href="{{ route('legal.privacy') }}"
                                class="text-gray-400 hover:text-blue-400 transition-colors">Kebijakan Privasi</a></li>
                        <li><a href="{{ route('legal.disclaimer') }}"
                                class="text-gray-400 hover:text-blue-400 transition-colors">Disclaimer</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        ...
                        <li class="flex items-center gap-3">
                            ...
                            <a href="mailto:info@mndproperti.com"
                                class="text-gray-400 hover:text-blue-400 transition-colors">info@mndproperti.com</a>
                        </li>
                        <li class="flex items-center gap-3">
                            <svg class="w-6 h-6 text-blue-500 flex-shrink-0" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
