                ...
                <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 sticky top-24">
                    @if($affiliate)
                        ...
                        <div class="space-y-3 mb-6">
                            ...
                            @endif
                            <button class="flex items-center justify-center w-full bg-white border-2 border-gray-200 hover:border-blue-500 hover:text-blue-600 text-gray-700 font-bold py-3 px-4 rounded-xl transition-all">
